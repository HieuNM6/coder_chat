...
URL: **https://peaceful-hamlet-93633.herokuapp.com/**
...
![Video Walkthrough](https://raw.githubusercontent.com/HieuNM6/coder_chat/master/Walkthrough.gif)

GIF created with [Silent Cast](https://github.com/colinkeenan/silentcast).

## Notes

Implemented User can attach an image but only working on local server not working on heroku and I need complete assignment to day. Therefore, I skip investigate.
